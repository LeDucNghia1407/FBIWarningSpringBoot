...
import com.javatechie.jpa.repository.OrdersRepository;
...
public class OrdersController {
    ...
    ResponseEntity<ResponseObject> checkOrders(@RequestBody Orders newOrders) { //Check if OrdersID is duplicate or not
        List<Orders> foundOrders = repository.findByid(newOrders.getId().trim());
    ...
    @PutMapping("/{id}")
    ResponseEntity<ResponseObject> updateOrders(@RequestBody Orders newOrders, @PathVariable String id) {
    ...
    ResponseEntity<ResponseObject> deleteOrders(@PathVariable String id) {
