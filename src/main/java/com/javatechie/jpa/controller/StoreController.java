...
public class StoreController {
    ...
    ResponseEntity<ResponseObject> checkStore(@RequestBody Store newStore) { //Check if StoreID is duplicate or not
        List<Store> foundStore = repository.findByid(newStore.getId().trim());
    ...
    @PutMapping("/{id}")
    ResponseEntity<ResponseObject> updateStore(@RequestBody Store newStore, @PathVariable String id) {
    ...
    ResponseEntity<ResponseObject> deleteStore(@PathVariable String id) {
